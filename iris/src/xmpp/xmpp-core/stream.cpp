...
class ClientStream::Private : public QObject
{
	Q_OBJECT
public:
...
#ifdef YAPSI
void ClientStream::setAllowXFacebookPlatform(bool allowXFacebookPlatform)
{
	d->allowXFacebookPlatform = allowXFacebookPlatform;
}
#endif
