...
| # | Задача | Статус | Описание |
|---|--------|--------|----------|
| 1 | Замена QCA | 🔲 | Системная QCA 2.3.x вместо встроенной 2.0.x — обязательно для SCRAM |
| 2 | TLS 1.2+ минимум | 🔲 | `QSsl::TlsV1_2OrLater` в `xmpp_clientstream.cpp`, отклонять даунгрейд |
| 3 | **Добавить** SCRAM-SHA-256 | 🔲 | Через QCA 2.3.x; должен работать end-to-end до шага 5 |
