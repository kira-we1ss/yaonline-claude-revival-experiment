...
Слой 5: Новые XMPP XEP (14/15 — OMEMO в процессе)                 🔄
...
*Последнее обновление: 2026-04-17 (Claude: **Слой 5 почти завершён (14/15 XEP), начата работа над XEP-0384 OMEMO.** В Слой 6 добавлены новые задачи: кнопка OMEMO-замок в заголовке чата (зелёный/серый + переключение), кнопка-карандаш для исправления сообщения с меткой "(изменено)". Таббар требует доработки.)*
