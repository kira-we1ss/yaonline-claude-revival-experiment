 ...
 * \see GrowlNotifier
 */
class PsiGrowlNotifier : public PsiNotifierBase
{
	Q_OBJECT
public:
	PsiGrowlNotifier(QObject* parent, const QStringList& notifications, const QStringList& defaults, const QString& appName);
