...
{
	{
		...
		IconAction* showIcons = new IconAction(tr("Show Icons"), tr("Show Icons"), 0, viewGroups, 0, true);
		showIcons->setWhatsThis(tr("Toggles visibility of avatar icons of contacts"));

		IconAction* showLargeIcons = new IconAction(tr("Show Large Icons"), tr("Show Large Icons"), 0, viewGroups, 0, true);
		showLargeIcons->setWhatsThis(tr("Toggles size of avatar icons of contacts"));
		...
		ActionNames actions[] = {
			...
			{ "show_largeicons", showLargeIcons },
			{ "", 0 }
		};
