...
protected slots:
	...
	bool updateGroupExpandedStateEnabled() const;
	void setUpdateGroupExpandedStateEnabled(bool enabled);
...
protected:
	...
	virtual ContactListItemMenu* createContextMenuFor(const QModelIndexList& indexes) const;
...
private:
	...
	bool updateGroupExpandedStateEnabled_;
};
