...
public:
	...
	static QString getOpenAnyFileName(QWidget* parent);
	static QStringList getOpenAnyFileNames(QWidget* parent);
	...
	static QStringList getOpenFileNames(QWidget* parent = 0, const QString& caption = QString(), const QString& filter = QString(), QString* selectedFilter = 0);
