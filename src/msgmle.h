...
class ChatEdit : public SpellCheckingTextEdit
{
	Q_OBJECT
...
#ifdef YAPSI
	void setUploadFileAction(QAction* uploadFileAction);
	void setRecentFilesMenu(QMenu* recentFilesMenu);
