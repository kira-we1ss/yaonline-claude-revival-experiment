/*
 * growlnotifier.h - Desktop notification stub (formerly Growl, now no-op)
 *
...
{
public:
	GrowlNotifier(QObject* parent, const QStringList& notifications, const QStringList& defaults, const QString& appName);
	~GrowlNotifier();
