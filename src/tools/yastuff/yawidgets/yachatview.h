...
public:
	...
	void setGroupchatMode(bool groupchatMode);
...
private slots:
	...
	void autoScroll();
	void modelReset();
	void composingEventTimerTimeout();
...
private:
	...
	QRect composingEventRect() const;
	QRect faderRect();
	...
	bool hoveringText_;
	QString link_;
	bool composingEventVisible_;
	int composingEventPixmapIndex_;
	QTimer* composingEventTimer_;
};
