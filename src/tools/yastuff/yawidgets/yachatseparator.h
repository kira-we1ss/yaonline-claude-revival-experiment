...
class YaChatSeparatorPushButton : public QPushButton
{
	Q_OBJECT
public:
	YaChatSeparatorPushButton(const QString& text, bool doWrap, QWidget* parent);
...
class YaChatSeparatorUploadButton : public YaChatSeparatorPushButton
{
	Q_OBJECT
public:
	YaChatSeparatorUploadButton(QWidget* parent);
...
private:
	...
	int numLines() const;
	int chatEditMaximumHeight() const;
	int chatEditHeight(int numLines) const;
};
