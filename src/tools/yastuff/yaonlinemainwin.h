...
class YaWin7Window : public YaWindow
{
	Q_OBJECT
public:
...
private:
	...
	HICON iconHandle_;
	QString accessibilityHint_;
#endif
};

class YaOnlineMainWin : public YaWin7Window
{
	Q_OBJECT
public:
...
private:
	...
	bool showRosterWithoutActivation_;
#endif
	XMPP::Status::Type lastStatusType_;
	bool lastHaveAvailableAccounts_;
};
