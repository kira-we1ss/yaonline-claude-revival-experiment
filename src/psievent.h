...
public:
	...
	bool shownInOnline() const;
	void setShownInOnline(bool shownInOnline);
#endif
...
public:
	...
	bool isForcedDescription() const;
	void setForcedDescription(const QString& description);
	virtual QString description() const;

#ifdef YAPSI
	void setMultiContactCount(int count);
	int multiContactCount() const;
#endif
...
private:
	...
	QString forcedDescription_;
#ifdef YAPSI
	int multiContactCount_;
#endif
};
...
#ifdef YAPSI
class MoodEvent : public PsiEvent
{
	Q_OBJECT
public:
	MoodEvent(const XMPP::Jid& j, const QString& mood, PsiAccount* acc);
	MoodEvent(const MoodEvent& from);
	~MoodEvent();
...
class GroupchatInviteEvent : public PsiEvent
{
	Q_OBJECT
public:
	GroupchatInviteEvent(const XMPP::Jid& j, const XMPP::Jid& groupchat, const QString& reason, const QString& password, PsiAccount* acc);
	GroupchatInviteEvent(const GroupchatInviteEvent& from);
	...
	XMPP::Jid groupchat() const;
	void setGroupchat(const XMPP::Jid &j);
...
private:
	QString v_password;
	XMPP::Jid v_groupchat;
	QString v_reason;
};

class GroupchatAlertEvent : public PsiEvent
{
	Q_OBJECT
public:
	GroupchatAlertEvent(const XMPP::Jid& j, const QString& message, PsiAccount* acc);
	GroupchatAlertEvent(const GroupchatAlertEvent& from);
	~GroupchatAlertEvent();
