...
QWidget *OptionsTabAdvanced::widget()
{
	...
	d->ck_spell->setEnabled(spellCheckerAvailable());
...
bool OptionsTabAdvanced::spellCheckerAvailable() const
{
	// FIXME: use PsiCon* instead of NULL pointer
	return SpellChecker::instance(0)->available();
}
